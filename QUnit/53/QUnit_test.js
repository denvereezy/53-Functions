...
QUnit.test( "longest_word", function( assert ) {
        var sentence = ("I am Denver and thats it universe");
  	    var result = longest_word(sentence);
        assert.equal("universe 8", result);
...
QUnit.test( "ends", function( assert ) {
        var sentence = ("I dm Denver Daniels dnd im dwesome");
  	    var result = ends(sentence);
...
QUnit.test( "add", function( assert ) {
    var number1 = 20;
    var number2 = 20;
  	var result = adding(number1, number2);
